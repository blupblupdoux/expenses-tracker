 ...
 */
final class Version20210301135430 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE transaction ADD created_at DATETIME NOT NULL, ADD updated_at DATETIME DEFAULT NULL');
